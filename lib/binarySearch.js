 ...
 *   It should return: a negative number if value is too low, zero if target matches, or a positive number if value is too high.
...
function binarySearch(arrayOrMax, targetOrTest, matchMode = 0){
    ...
    if(typeof targetOrTest == 'function'){
        ...
        test = val => binarySearch.compare(val, targetOrTest)
    }
...
binarySearch.compare = (val, target)=>{
