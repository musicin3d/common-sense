 ...
 *   It should return a promise that resolves to: a negative number if value is too low, zero if target matches, or a positive number if value is too high.
...
binarySearchAsync.compare = (val, target)=>{
